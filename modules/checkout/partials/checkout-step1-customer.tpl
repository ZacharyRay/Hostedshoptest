...
Modifications:
- Line 26: Added select menu with customer type options
...
<div class="contactInfoContainer">
        <fieldset class="form-group">
            <label class="form-label">
                {$text.TEXT_CUSTOMER_TYPE}
            </label>
            <select class="form-input form-select" type="select" id="customer-type-select">
                <option value="privat" selected>{$text.TEXT_TYPE_PRIVATE}</option>
                <option value="virksomhed">{$text.TEXT_TYPE_BUSINESS}</option>
                <option value="offentlig">{$text.TEXT_TYPE_PUBLIC}</option>
            </select>
        </fieldset>
