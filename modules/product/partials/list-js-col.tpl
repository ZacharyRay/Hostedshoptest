...
Modifications:
- Line 48: Added data attributes to sales badge in order to calculate percentage
- Line 137: Rearranged order of items - variant dropdowns moved down to just above action button
- Line 147: Added class to amount field
	...
	<form method="post" action="/actions/cart/add">
		...
		<figure class="image m-productlist-figure">
			...
			<div class="splash m-productlist-splash" data-ng-show="::settings.show_product_icons">
				...
				<span class="badge badge-warning m-productlist-sale" data-ng-if="onSale" data-ng-bind-html="::text.SALE" data-fullprice="{{discount}}" data-discountprice="{{price}}"></span>
