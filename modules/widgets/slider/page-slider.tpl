...
Modifications:
- Line 63: Load a different slider file for the page sliders, preventing errors on product images
...
{include file="modules/widgets/slider/top-slider.tpl" widgetSettings=$sliderSettings type=page id=$page.id}
